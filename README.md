...
- Интеграция + развертывание: развертывание приложения, БД, настройка и развертывание инструмента для реализации очереди (Kafka и т.д.)
37. Тема 1. Морской бой Онлайн
- Фронтенд + аналитика: интерфейс игры
- Бекенд : реализация комнат, передачи данных противника по web-socket, сохранение статистики в БД
- Интеграция + развертывание: развертывание приложения, БД
38. Тема 1. Шахматы Онлайн
- Фронтенд + аналитика: интерфейс игры
- Бекенд : реализация комнат, передачи данных противника по web-socket, сохранение статистики в БД
- Интеграция + развертывание: развертывание приложения, БД
39. Тема 1. Шашки Онлайн
- Фронтенд + аналитика: интерфейс игры
- Бекенд : реализация комнат, передачи данных противника по web-socket, сохранение статистики в БД
- Интеграция + развертывание: развертывание приложения, БД
40. Тема 1. Сайт-аукцион (ebay)
- Фронтенд + аналитика: интерфейс сайта-аукциона
- Бекенд : реализация обновление списка товаров и актуальных ставок через web-socket
- Интеграция + развертывание: развертывание приложения, БД
41. Тема 1. Лента новостей с реакциями
- Фронтенд + аналитика: интерфейс ленты новостей
- Бекенд : реализация добавления новых новостей, возможность оставлять реакции и получать push-уведомления, если кто-то оставил реакцию на вашу новость, через web-socket
- Интеграция + развертывание: развертывание приложения, БД
42. Тема 1. Домино Онлайн
- Фронтенд + аналитика: интерфейс игры
- Бекенд : реализация комнат, передачи данных противника по web-socket, сохранение статистики в БД
- Интеграция + развертывание: развертывание приложения, БД
43. Тема 3. Хостинг html-страниц и отображение на странице
- Фронтенд + аналитика: html-страницы, страница отображения
- Бекенд : генерация html, сохранение их в S3, передача ссылок на фронт
- Интеграция + развертывание: развертывание приложения, БД, настройка и развертывание S3
44. ...
45. ...
46. ...
