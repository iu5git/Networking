...
#### 1. Реализовать поверх long polling свой tcp - гарантированную доставку

Одна сторона отправляет набор сообщений второй. Нужно их пронумеровать и собрать вместе. Если что-то потерялось - запросить повторно, если повторно пришло - использовать один раз. Если не приходит после 3-5 раз (по варианту) - вывести ошибку пользователю 

Одна из сторон с заданной вероятностью «забывает» отправить сообщение (квитанцию или полезное сообщение)

#### 2. Реализовать поверх long polling свой канальный уровень для исправления ошибок (циклический код или Хеминг)
...
[Ролик по Long Polling](https://youtu.be/o43iiH4kGqg)
...
- [Пример реализации веб-сервиса DRF](https://github.com/iu5git/web-2022/blob/main/tutorials/lab5-py/README.md)
- [Пример реализации веб-сервиса Golang](https://github.com/iu5git/web-2022/blob/main/tutorials/lab5-go/README.md)
