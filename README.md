...
6. ПМИ (три части для каждого из участников) - тестирование всего основного функционала приложения в таблице по пунктам (функция из ТЗ, действие, результаты и маленький скриншот): отправка сообщения, авторизация, предоставление прав администратором пользователям, передача файла (у кого есть) и тд.
...
5. Потом каждый отвечает по своей части. Упор на сетевое взаимодействие: кто какие ноды/компоненты делал, какие протоколы 
